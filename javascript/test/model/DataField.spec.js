...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.DataField();
  });
  ...
  describe('DataField', function() {
    it('should create an instance of DataField', function() {
      ...
      //var instane = new TruliooIdentityVerification.DataField();
      //expect(instance).to.be.a(TruliooIdentityVerification.DataField);
    });
