...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.ServiceError();
  });
  ...
  describe('ServiceError', function() {
    it('should create an instance of ServiceError', function() {
      ...
      //var instane = new TruliooIdentityVerification.ServiceError();
      //expect(instance).to.be.a(TruliooIdentityVerification.ServiceError);
    });
