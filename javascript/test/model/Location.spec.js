...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new TruliooIdentityVerification.Location();
      //expect(instance).to.be.a(TruliooIdentityVerification.Location);
    });
