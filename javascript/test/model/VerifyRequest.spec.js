...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.VerifyRequest();
  });
  ...
  describe('VerifyRequest', function() {
    it('should create an instance of VerifyRequest', function() {
      ...
      //var instane = new TruliooIdentityVerification.VerifyRequest();
      //expect(instance).to.be.a(TruliooIdentityVerification.VerifyRequest);
    });
