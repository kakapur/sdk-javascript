...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.NationalId();
  });
  ...
  describe('NationalId', function() {
    it('should create an instance of NationalId', function() {
      ...
      //var instane = new TruliooIdentityVerification.NationalId();
      //expect(instance).to.be.a(TruliooIdentityVerification.NationalId);
    });
