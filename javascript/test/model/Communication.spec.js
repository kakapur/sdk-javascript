...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.Communication();
  });
  ...
  describe('Communication', function() {
    it('should create an instance of Communication', function() {
      ...
      //var instane = new TruliooIdentityVerification.Communication();
      //expect(instance).to.be.a(TruliooIdentityVerification.Communication);
    });
