...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.NormalizedDatasourceGroupCountry();
  });
  ...
  describe('NormalizedDatasourceGroupCountry', function() {
    it('should create an instance of NormalizedDatasourceGroupCountry', function() {
      ...
      //var instane = new TruliooIdentityVerification.NormalizedDatasourceGroupCountry();
      //expect(instance).to.be.a(TruliooIdentityVerification.NormalizedDatasourceGroupCountry);
    });
