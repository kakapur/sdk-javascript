...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.DatasourceResult();
  });
  ...
  describe('DatasourceResult', function() {
    it('should create an instance of DatasourceResult', function() {
      ...
      //var instane = new TruliooIdentityVerification.DatasourceResult();
      //expect(instance).to.be.a(TruliooIdentityVerification.DatasourceResult);
    });
