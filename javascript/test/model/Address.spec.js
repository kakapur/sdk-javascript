...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.Address();
  });
  ...
  describe('Address', function() {
    it('should create an instance of Address', function() {
      ...
      //var instane = new TruliooIdentityVerification.Address();
      //expect(instance).to.be.a(TruliooIdentityVerification.Address);
    });
