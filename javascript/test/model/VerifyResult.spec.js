...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.VerifyResult();
  });
  ...
  describe('VerifyResult', function() {
    it('should create an instance of VerifyResult', function() {
      ...
      //var instane = new TruliooIdentityVerification.VerifyResult();
      //expect(instance).to.be.a(TruliooIdentityVerification.VerifyResult);
    });
