...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.DatasourceField();
  });
  ...
  describe('DatasourceField', function() {
    it('should create an instance of DatasourceField', function() {
      ...
      //var instane = new TruliooIdentityVerification.DatasourceField();
      //expect(instance).to.be.a(TruliooIdentityVerification.DatasourceField);
    });
