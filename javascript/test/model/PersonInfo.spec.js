...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.PersonInfo();
  });
  ...
  describe('PersonInfo', function() {
    it('should create an instance of PersonInfo', function() {
      ...
      //var instane = new TruliooIdentityVerification.PersonInfo();
      //expect(instance).to.be.a(TruliooIdentityVerification.PersonInfo);
    });
