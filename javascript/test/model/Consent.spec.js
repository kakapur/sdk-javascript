...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.Consent();
  });
  ...
  describe('Consent', function() {
    it('should create an instance of Consent', function() {
      ...
      //var instane = new TruliooIdentityVerification.Consent();
      //expect(instance).to.be.a(TruliooIdentityVerification.Consent);
    });
