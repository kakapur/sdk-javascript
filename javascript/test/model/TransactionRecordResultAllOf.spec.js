...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.TransactionRecordResultAllOf();
  });
  ...
  describe('TransactionRecordResultAllOf', function() {
    it('should create an instance of TransactionRecordResultAllOf', function() {
      ...
      //var instane = new TruliooIdentityVerification.TransactionRecordResultAllOf();
      //expect(instance).to.be.a(TruliooIdentityVerification.TransactionRecordResultAllOf);
    });
