...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TruliooIdentityVerification.Passport();
  });
  ...
  describe('Passport', function() {
    it('should create an instance of Passport', function() {
      ...
      //var instane = new TruliooIdentityVerification.Passport();
      //expect(instance).to.be.a(TruliooIdentityVerification.Passport);
    });
