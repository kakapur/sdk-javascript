...
export default class ConfigurationApi {
    ...
    */
     ...
     * @param {String} mode free trial or live
     ...
     */
    getConsents(mode, countryCode, configurationName, callback) {
      let postBody = null;
     ...
     * data is of type: {@link Array.<String>}
     */
    getCountryCodes(mode, configurationName, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     */
    getCountrySubdivisions(mode, countryCode, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     */
    getDatasources(mode, configurationName, countryCode, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     */
    getDetailedConsents(mode, countryCode, configurationName, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     */
    getFields(mode, countryCode, configurationName, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     * data is of type: {@link Object}
     */
    getRecommendedFields(mode, countryCode, configurationName, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
     ...
     */
    getTestEntities(mode, configurationName, countryCode, callback) {
      let postBody = null;
      // verify the required parameter 'mode' is set
      if (mode === undefined || mode === null) {
