...
* <pre>
* var TruliooIdentityVerification = require('index'); // See note below*.
* var xxxSvc = new TruliooIdentityVerification.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new TruliooIdentityVerification.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new TruliooIdentityVerification.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new TruliooIdentityVerification.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
