...
class DatasourceField {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('MatchPrecision')) {
                obj['MatchPrecision'] = ApiClient.convertToType(data['MatchPrecision'], 'String');
            }
...
/**
 * @member {String} MatchPrecision
 */
DatasourceField.prototype['MatchPrecision'] = undefined;
